...
class checkCompletePopup: UIViewController {
    ...
    private lazy var nameTitleLabel: UILabel? = {
        ...
        if let attributedMessageText = attributedMessageText {
            titleLabel.attributedText = attributedMessageText
        }
...
extension UIViewController {
    func showPopUp(title: String? = nil,
        ...
        let checkCompletePopup = checkCompletePopup(titleText: title,
                                                      messageText: message,
                                                      attributedMessageText: attributedMessage)
        showPopUp(checkCompletePopup: checkCompletePopup,
    ...
    func showPopUp(contentView: UIView,
                   ...
                   leftActionCompletion: (() -> Void)? = nil,
                   rightActionCompletion: (() -> Void)? = nil) {
        let checkCompletePopup = checkCompletePopup(contentView: contentView)
    ...
    private func showPopUp(checkCompletePopup: checkCompletePopup,
                           leftActionTitle: String?,
                           rightActionTitle: String,
                           leftActionCompletion: (() -> Void)?,
                           rightActionCompletion: (() -> Void)?) {
        checkCompletePopup.addActionToButton(title: leftActionTitle,
                                              titleColor: .systemGray,
                                              backgroundColor: .secondarySystemBackground) {
            checkCompletePopup.dismiss(animated: false, completion: leftActionCompletion)
        }

        checkCompletePopup.addActionToButton(title: rightActionTitle,
                                              titleColor: .white,
                                              backgroundColor: .blue) {
            checkCompletePopup.dismiss(animated: false, completion: rightActionCompletion)
        }
        present(checkCompletePopup, animated: false, completion: nil)
    }
}
